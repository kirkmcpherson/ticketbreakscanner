...
/**
 ...
 @param btDeviceAddress bluetooth device address, as returned by the discovery
 @param pin connection pin, or nil to try insecure connection to the device
 @param error returns error information, you can pass nil if you don't want it
 @return TRUE upon success, FALSE otherwise
 **/
-(BOOL)btConnect:(NSString *)btDeviceAddress pin:(NSString *)pin error:(NSError **)error;
...
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)pageSetWorkingArea:(int)left top:(int)top width:(int)width height:(int)height;
/**
 Sets a working area and orientation inside the virtual page. No drawing can ever occur outside the said area
 @param left, top, width, height working area rectangle in absolute pixels (i.e. does not depend on the page orientation)
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)pageSetWorkingArea:(int)left top:(int)top width:(int)width heigth:(int)height orientation:(int)orientation;
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)pageFillRectangle:(int)color;
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)pageFillRectangle:(int)left top:(int)top width:(int)width height:(int)height color:(int)color;
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)pageRectangleFrame:(int)left top:(int)top width:(int)width height:(int)height framewidth:(int)framewidth color:(int)color;
/**@}*/
...
/**
 ...
 @return first uint8_t is the protocol number (0=T0, 1=T1), the rest is ATR(Answer To Reset) data
 */
-(NSData *)scReset;
/**
 ...
 @return SmartCard Response struct
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(NSData *)scAPDU:(int)cla ins:(int)ins p1:(int)p1 p2:(int)p2 data:(NSData *)data maxrcvlen:(int)maxrcvlen;
/**@}*/
...
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableAddColumn:(int)font style:(int)style alignment:(int)alignment;
/**
 Adds a new column
 @param font one of the FONT_size constants
 @param style one or more of the font style constants (FONT_BOLD, FONT_ITALIC, etc)
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableAddColumn:(int)font style:(int)style alignment:(int)alignment flags:(int)flags;
/**
 Adds a new cell using the font size and style and aligning of the column that cell belongs to
 @param data string data
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableAddCell:(NSString *)data;
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableAddCell:(NSString *)data font:(int)font;
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableAddCell:(NSString *)data font:(int)font style:(int)style;
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableAddCell:(NSString *)data font:(int)font style:(int)style alignment:(int)alignment;
/**
 Adds aa horizontal black line to the entire row that separates it from the next
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableAddDelimiter;
/**
 ...
 @throw NSPortTimeoutException if there is no connection to the printer
 */
-(void)tableSetRowHeight:(int)height;
/**
...
/**
 ...
 @return 16 bytes of random numbers
 @throw NSPortTimeoutException if there is no connection to the printer
 @throw NSInvalidArgumentException if old key is invalid
 */
...
/**
 ...
 @return random data, encrypted with the printer's authentication key
 @throw NSPortTimeoutException if there is no connection to the printer
 @throw NSInvalidArgumentException if random data is invalid
 */
-(NSData *)cryptoRawAuthenticatePrinter:(NSData *)randomData;
...
/**
 ...
 @throw NSInvalidArgumentException if random data is invalid
 */
-(BOOL)cryptoAuthenticatePrinter:(NSData *)key;

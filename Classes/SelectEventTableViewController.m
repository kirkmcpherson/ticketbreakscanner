//
//  SelectEventTableViewController.m
//  TicketBreakScanner
//
...
@implementation SelectEventTableViewController

@synthesize scanTicketViewController;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    */
	...
	if(self.scanTicketViewController == nil) {
		ScanTicketViewController *d = [[ScanTicketViewController alloc]initWithNibName:@"ScanTicketViewController" bundle:[NSBundle mainBundle]];
		self.scanTicketViewController = d;
		[d release];
	}
	
	self.scanTicketViewController.authUserID = authUserID;
	self.scanTicketViewController.email = email;
	//self.scanTicketViewController.eventName = message;
	//self.scanTicketViewController.eventID = message2;
	
	[self.navigationController pushViewController:self.scanTicketViewController animated:YES];
...
- (void)dealloc {
	[url release];
	[venueID release];
	[scanTicketViewController release];
	[authUserID release];
	[email release];
